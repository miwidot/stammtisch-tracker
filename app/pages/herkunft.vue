<template>
  <UContainer class="px-4 py-10 sm:px-6 sm:py-14">
    <div class="mx-auto flex w-full max-w-3xl flex-col gap-10">
      ...
      <section :class="sectionClasses" aria-labelledby="herkunft-contributions-heading">
        <h2
          id="herkunft-contributions-heading"
          class="text-primary-300/80 text-xs font-semibold tracking-widest uppercase"
        >
          {{ t('page.herkunft.contributions.heading') }}
        </h2>
        <ul class="text-surface-300 mt-4 list-disc space-y-1 pl-5 text-sm leading-relaxed">
          <li>
            <i18n-t keypath="page.herkunft.contributions.translation" scope="global">
              <template #pr_280>
                <a
                  href="https://github.com/tarkovtracker-org/TarkovTracker/pull/280"
                  :class="linkClasses"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {{ t('page.herkunft.contributions.pr_280_label') }}
                  <span class="sr-only">({{ t('common.opens_in_new_tab') }})</span>
                </a>
              </template>
              <template #pr_281>
                <a
                  href="https://github.com/tarkovtracker-org/TarkovTracker/pull/281"
                  :class="linkClasses"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {{ t('page.herkunft.contributions.pr_281_label') }}
                  <span class="sr-only">({{ t('common.opens_in_new_tab') }})</span>
                </a>
              </template>
            </i18n-t>
          ...
          <li>
            <i18n-t keypath="page.herkunft.contributions.overlay" scope="global">
              <template #pr_overlay>
                <a
                  href="https://github.com/tarkovtracker-org/tarkov-data-overlay/pull/388"
                  :class="linkClasses"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {{ t('page.herkunft.contributions.pr_overlay_label') }}
                  <span class="sr-only">({{ t('common.opens_in_new_tab') }})</span>
                </a>
              </template>
            </i18n-t>
          ...
          <li>
            <i18n-t keypath="page.herkunft.contributions.bugfix" scope="global">
              <template #pr_bugfix>
                <a
                  href="https://github.com/tarkovtracker-org/TarkovTracker/pull/848"
                  :class="linkClasses"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {{ t('page.herkunft.contributions.pr_bugfix_label') }}
                  <span class="sr-only">({{ t('common.opens_in_new_tab') }})</span>
                </a>
              </template>
            </i18n-t>
