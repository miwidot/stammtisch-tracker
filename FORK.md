...
| `app/assets/css/tailwind.css`                                                                 | 6      | Farbwerte im `@theme static` — gedaempftes Militaer-Oliv (`#697a3a`) auf gruenstichigem Dunkel (`#10110e`), HSL und OKLCH synchron gepflegt                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | reiner Werte-Patch                                                                                                                                                                                                                                                  |
